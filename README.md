...
- **[GTSAM Implementation Details](docs/04_gtsam_implementation.md)** — Detailed implementation notes for the GTSAM SLAM node: factor implementations, occupancy grid map generation, configuration parameters, node topics, build notes, and known limitations.
